            ...
            <div key={vaccine._id} className="mating-record-item">
              <div className="mating-record-info">
                ...
                <ul>
                  ...
                  {vaccine.entryType && (
                    <li>
                      <strong>{t("entry_type")}:</strong> {vaccine.entryType}
                    </li>
                  )}
                  {vaccine.locationShed?.name && (
                    <li>
                  ...
                  {vaccine.vaccine?.name && (
                    <li>
                      <strong>{t("Vaccine_Name")}:</strong>{" "}
                      {vaccine.vaccine.name}
                    </li>
                  )}
                  {vaccine.vaccine?.diseaseType && (
                    <li>
                      <strong>{t("Disease_Type")}:</strong>{" "}
                      {vaccine.vaccine.diseaseType}
                    </li>
                  )}
                  {vaccine.vaccine?.dosePrice != null && (
                    <li>
                      <strong>{t("Dose_Price")}:</strong>{" "}
                      {vaccine.vaccine.dosePrice}
                    </li>
                  )}
                  {vaccine.vaccine?.boosterDose != null && (
                    <li>
                      <strong>{t("Booster_Dose")}:</strong>{" "}
                      {vaccine.vaccine.boosterDose}
                    </li>
                  )}
                  {vaccine.vaccine?.annualDose != null && (
                    <li>
                      <strong>{t("Annual_Dose")}:</strong>{" "}
                      {vaccine.vaccine.annualDose}
                    </li>
                  )}
                  {vaccine.vaccine?.isExpired != null && (
                    <li>
                      <strong>{t("Is_Expired")}:</strong>{" "}
                      {vaccine.vaccine.isExpired ? t("Yes") : t("No")}
                    </li>
                  )}
                </ul>
              </div>
