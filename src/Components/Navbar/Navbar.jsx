...
export default function Navbar({ toggleSidebar }) {
    ...
    return (
        <nav className="navbar p-3 mb-2 fixed-top navbar-dark navbar-expand-lg" style={{ backgroundColor: "#F3F3F3" }}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        {Authorization !== null ? (
                            <li className="nav-item">
                                <Link onClick={LogOut} className="nav-link active" style={{ color: "#0C0D0E" }}>
                                    LogOut
                                </Link>
                            </li>
                        ) : (
                            <>
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="Register" style={{ color: "#0C0D0E" }}>
                                        Register
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="Login" style={{ color: "#0C0D0E" }}>
                                        Login
                                    </Link>
                                </li>
                            </>
