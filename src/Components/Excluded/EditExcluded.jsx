...
export default function EditExcluded() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      weight: Yup.string().when('excludedType', {
        is: (type) => type === 'sale' || type === 'sweep',
        then: (schema) => schema.required(t('weight_required')),
      }),
          ...
          <div className="form-section">
            ...
            {formik.values.excludedType === 'death' && (
              <div className="input-group">
                ...
                />
                {formik.errors.reasoneOfDeath &&
                  formik.touched.reasoneOfDeath && (
